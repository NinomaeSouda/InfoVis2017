function Isosurfaces( volume, isovalue, changeColor )
{
...
/*_____________________________________________*/
    ...
    {
    	  var IS = Math.round(changeColor);
        var C0 = new THREE.Color().setHex( cmap[ IS ][1] );
        var C1 = new THREE.Color().setHex( cmap[ IS ][1] );
        var C2 = new THREE.Color().setHex( cmap[ IS ][1] );
