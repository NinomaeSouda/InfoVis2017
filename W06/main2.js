function main()
{
    ...
    geometry.faces[2].color = new THREE.Color(0.9, 0.9, 0.9);
    geometry.faces[3].color = new THREE.Color(0.9, 0.9, 0.9);
    geometry.faces[4].color = new THREE.Color(0.8, 0.8, 0.8);
    geometry.faces[5].color = new THREE.Color(0.8, 0.8, 0.8);
    
    geometry.faces[6].color = new THREE.Color(0.95, 0.95, 0.95);
    geometry.faces[7].color = new THREE.Color(0.95, 0.95, 0.95);
    geometry.faces[8].color = new THREE.Color(0.85, 0.85, 0.85);
    geometry.faces[9].color = new THREE.Color(0.85, 0.85, 0.85);
    geometry.faces[10].color = new THREE.Color(0.75, 0.75, 0.75);
    geometry.faces[11].color = new THREE.Color(0.75, 0.75, 0.75);
